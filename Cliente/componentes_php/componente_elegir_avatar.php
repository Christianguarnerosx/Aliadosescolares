    <!-- Con este componente se podra modificar para que siempre parezcan/registren los mismos avatares en todas las interfaces que se necesiten -->
    <!-- Para que se pueda utilizar es necesario de su js (<script src="js/confirmar_avatar.js"></script>) -->
