<div class="container-fluid"> <!-- contenedor de todo el componente (para solo traerlo y no configurar nada) -->
    <div class="row alinear-center"> <!-- Hace que los textos (titulo y subtitulo de la interfaz): de hola(nombre usuario) y psicologia -->
        <div class="col">
            ...
            <div class="row centrar"> <!-- Fila del chat -->
                <div class="row centrar">
                    <h1 for="textareagemini" class="form-label">Soy tu PsicologIA</h1> <!-- Titulo que se mantiene para el contenedor del chat -->
...
<script type="module" src="../js/JSEstructuras/estructuras_psicologia.js"></script>